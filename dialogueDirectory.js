...
export const dialogueDirectory = {
    ...
    dog : {
        normal : [
            ...
            {
                text : "testing @rgb(255,2,2)/shake(1)/speedMs(100)/custom font! @end now! And never ever try this again I really hope @rgb(0,255,0)/text @end isn't just 1 big text box",
            },
            {
    ...
    Angry_man: {
        normal : [
            ...
            {
                text:"You @size(50)/shake(2)/rgb(250,120,83)/BRAT! @end , I hate the way you're eyeing me!",
                voice:"Male_1",
            },
            {
                battle: {
                    enemies : ["grass_dweller"],
                    backgroundData: [
    ...
    stealer: {
        normal : [
            ...
            {
                text:"Mind telling me the @rgb(105,82,206)/3 @end numbers on the back of your @rgb(187,9,172)/credit card? @end and the number on the back of it too?"
            },
            {
                text:"@wavy(15,6)/You can't find me bruh @end"
            },
            {
        ...
        normal : [
            {
                ...
                choices:[
                    ...
                    {
                        text:"A Nihilistic subordinate",
                        readFrom:["nihilism",true],
                        writeTo:["Thinker",4],
                    },
                    {
                        text:"baby ross",
                        readFrom:["artistic",true],
                        writeTo:["Thinker",5],
                    },
                ]
            },
            {
                text:"If your answer doesn't matter, do you truly have free will or are you bound to the confines of the electrical reactions inside your brain?",
            },
            {
                condition:{
                    check:["Thinker",1],
    ...
    chill_guy:{
        normal : [
            {
                text:"Hey I'm just a @rgb(82,206,183)/wavy(5,6)/chill @end guy man",
                voice:"Male_4",
            },
            {
                text:"I should theoretically appear only if a certain value in your @rgb(82,144,206)/shake(1)/internalData @end is met",
                voice:"Male_4",
            }
        ]
    },
    thinker2:{
        normal : [
            {
                text:"Did you talk to me sister?!",
                voice:"Female_1",
            },
            {
                text:"She's gone mad after reading that book about Socrates! What an accursed man!",
                voice:"Female_1",
                // writeTo:["artistic",true],
            },
            {
                writeTo:["artistic",true],
            }
